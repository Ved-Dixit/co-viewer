...
function init() {
  // Try to connect to the same host as the web app for signaling, fallback to localhost
  const wsUrl = window.location.hostname === 'localhost' ? 'ws://localhost:8080' : `wss://${window.location.hostname}/ws`;
